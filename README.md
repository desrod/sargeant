...
Every option has a command-line flag and a matching `SG_*` environment variable. The environment variable sets the default, and an explicit flag overrides it. That is what lets the Docker image be configured entirely through `environment:`.
